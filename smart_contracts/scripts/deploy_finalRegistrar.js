...
async function main() {
  ...
  const MyNewRegistrar = await ethers.getContractFactory("MyNewRegistrar")
...
//   const PublicResolver = await ethers.getContractFactory("PublicResolver")
  ...
  const registrar = await MyNewRegistrar.deploy(ens.address, namehash.hash(tld));
  await registrar.deployed()
  await setupRegistrar(ens, registrar);
  console.log("MyNewRegistrar deployed to:", registrar.address);

  await registrar.setRelayer(relayerAddress);
